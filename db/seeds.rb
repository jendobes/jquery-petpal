...
Pet.create(name: 'Rover', age: 4, bio: "Cute dog needs home", gender: "Male", species: "Dog", breed: "Collie", kill_shelter: true, fosterer: false, adopter: true)
Pet.create(name: 'Buddah', age: 1, bio: "Energetic Puppy", gender: "Male", species: "Dog", breed: "Mix", kill_shelter: false, fosterer: false, adopter: true)
Pet.create(name: 'Sparky', age: 9, bio: "Elderly cat needs a buddy", gender: "Male", species: "Cat", breed: "Long Haired", kill_shelter: true, fosterer: false, adopter: true)
Pet.create(name: 'Russel', age: 2, bio: "Snuggly kitty cat", gender: "Male", species: "Cat", breed: "Calico", kill_shelter: false, fosterer: true, adopter: true)
Pet.create(name: 'Buddy', age: 10, bio: "Cute old man dog, low energy but cuddly", gender: "Male", species: "Dog", breed: "Golden Retriever", kill_shelter: true, fosterer: true, adopter: true)
Pet.create(name: 'Lady', age: 1, bio: "Peppy little pupper", gender: "Female", species: "Dog", breed: "bull dog", kill_shelter: false, fosterer: false, adopter: true)
Pet.create(name: 'Daisy', age: 2, bio: "What a doggo!", gender: "Female", species: "Dog", breed: "pit bull", kill_shelter: false, fosterer: true, adopter: false)
Pet.create(name: 'Sunflower', age: 3, bio: "Loves to chase mice", gender: "Female", species: "Cat", breed: "tabby", kill_shelter: true, fosterer: true, adopter: true)
Pet.create(name: 'Mittens', age: 5, bio: "Will be your companion", gender: "Female", species: "Cat", breed: "siamese", kill_shelter: false, fosterer: true, adopter: true)
Pet.create(name: 'Sunny', age: 1, bio: "Little kitten loves to play", gender: "Female", species: "Cat", breed: "hairless", kill_shelter: false, fosterer: true, adopter: false)
